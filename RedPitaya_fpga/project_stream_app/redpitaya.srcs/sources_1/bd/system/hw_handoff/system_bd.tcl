...
proc create_root_design { parentCell } {
  ...
  # Create instance: rp_counter_0, and set properties
  set block_name rp_counter
  set block_cell_name rp_counter_0
  if { [catch {set rp_counter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_counter_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_reg_M02_AXI [get_bd_intf_pins axi_reg/M02_AXI] [get_bd_intf_pins rp_counter_0/s_axi_reg]
  ...
  connect_bd_intf_net -intf_net rp_counter_0_m_axi_cnt [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins rp_counter_0/m_axi_cnt]
  ...
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_reg/M00_ARESETN] [get_bd_pins axi_reg/M01_ARESETN] [get_bd_pins axi_reg/M02_ARESETN] [get_bd_pins axi_reg/S00_ARESETN] [get_bd_pins rp_counter_0/m_axi_cnt_aresetn] [get_bd_pins rp_counter_0/rst_n] [get_bd_pins rp_counter_0/s_axi_reg_aresetn] [get_bd_pins rp_dac/rst_n] [get_bd_pins rp_dac/s_axi_reg_aresetn] [get_bd_pins rp_oscilloscope/m_axi_osc1_aresetn] [get_bd_pins rp_oscilloscope/m_axi_osc2_aresetn] [get_bd_pins rp_oscilloscope/rst_n] [get_bd_pins rp_oscilloscope/s_axi_reg_aresetn] [get_bd_pins rst_gen/peripheral_aresetn]
  ...
  connect_bd_net -net clk_wiz_0_adc_clk [get_bd_ports clk_out] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_reg/M00_ACLK] [get_bd_pins axi_reg/M01_ACLK] [get_bd_pins axi_reg/M02_ACLK] [get_bd_pins clk_gen/clk_125] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins rp_counter_0/clk] [get_bd_pins rp_counter_0/m_axi_cnt_aclk] [get_bd_pins rp_counter_0/s_axi_reg_aclk] [get_bd_pins rp_dac/clk] [get_bd_pins rp_dac/s_axi_reg_aclk] [get_bd_pins rp_oscilloscope/clk] [get_bd_pins rp_oscilloscope/m_axi_osc1_aclk] [get_bd_pins rp_oscilloscope/m_axi_osc2_aclk] [get_bd_pins rp_oscilloscope/s_axi_reg_aclk] [get_bd_pins xadc/s_axi_aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports rstn_out] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_gen/ext_reset_in] [get_bd_pins rst_gen2/ext_reset_in]
  connect_bd_net -net rp_concat_0_event_reset [get_bd_pins rp_concat/event_reset] [get_bd_pins rp_counter_0/event_ip_reset] [get_bd_pins rp_dac/event_ip_reset] [get_bd_pins rp_oscilloscope/event_ip_reset]
  connect_bd_net -net rp_concat_0_event_start [get_bd_pins rp_concat/event_start] [get_bd_pins rp_counter_0/event_ip_start] [get_bd_pins rp_dac/event_ip_start] [get_bd_pins rp_oscilloscope/event_ip_start]
  connect_bd_net -net rp_concat_0_event_stop [get_bd_pins rp_concat/event_stop] [get_bd_pins rp_counter_0/event_ip_stop] [get_bd_pins rp_dac/event_ip_stop] [get_bd_pins rp_oscilloscope/event_ip_stop]
  connect_bd_net -net rp_concat_event_trig [get_bd_pins rp_concat/event_trig] [get_bd_pins rp_counter_0/event_ip_trig] [get_bd_pins rp_dac/event_ip_trig] [get_bd_pins rp_oscilloscope/event_ip_trig]
  connect_bd_net -net rp_concat_ext_trig_ip [get_bd_ports trig_in] [get_bd_pins rp_concat/ext_trig_ip]
  connect_bd_net -net rp_concat_trig [get_bd_pins rp_concat/trig] [get_bd_pins rp_dac/trig_ip] [get_bd_pins rp_oscilloscope/trig_ip]
  ...
  connect_bd_net -net rp_expansion_to_in_0_gpio_out [get_bd_pins rp_counter_0/gpio_in] [get_bd_pins rp_expansion_to_in_0/gpio_out]
  ...
  assign_bd_address -offset 0x40200000 -range 0x00100000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rp_counter_0/s_axi_reg/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp_counter_0/m_axi_cnt] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
